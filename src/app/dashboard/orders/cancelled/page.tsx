...
export default async function CancelledPage() {
    ...
    return (
      <div className="rounded-xl border border-[#F3C6C2] bg-[#FDECEC] p-4 text-[#B42318]">
        <div className="flex gap-3">
          ...
          <div>
            <p className="font-bold">Failed to load cancelled orders</p>
  ...
  return (
    <>
      <section className="mb-4 rounded-2xl border border-[#F3C6C2] bg-[#FFF7F6] p-4 shadow-sm dark:border-[#5B2A2A] dark:bg-[#1F1717]">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#B42318] dark:text-[#FCA5A5]">
              Cancelled Orders
            </p>
          ...
          <div className="rounded-xl border border-[#F3C6C2] bg-white px-4 py-3 sm:text-right dark:border-[#5B2A2A] dark:bg-[#2A1A1A]">
            <p className="text-[10px] font-black uppercase tracking-[0.14em] text-[#667085] dark:text-[#AAB2BD]">
              Cancelled Value
            </p>

            <p className="mt-1 text-2xl font-black text-[#B42318] dark:text-[#FCA5A5]">
      ...
      {!orders.length ? (
        <div className="rounded-2xl border border-[#E6E1D8] bg-white p-8 text-center shadow-sm dark:border-[#2A2F35] dark:bg-[#171A1F]">
          <div className="mx-auto grid size-12 place-items-center rounded-full bg-[#FDECEC] text-[#B42318] dark:bg-[#2A1A1A] dark:text-[#FCA5A5]">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {orders.map((order) => (
            <article
              key={order.id}
              className="overflow-hidden rounded-2xl border border-[#F3C6C2] bg-white shadow-sm dark:border-[#5B2A2A] dark:bg-[#171A1F]"
            >
              <div className="border-b border-[#F3C6C2] bg-[#FFF7F6] p-4 dark:border-[#5B2A2A] dark:bg-[#2A1A1A]">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#B42318] dark:text-[#FCA5A5]">
                      Table
                    </p>
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2 text-[11px] text-[#667085] dark:text-[#AAB2BD]">
                      <span className="inline-flex items-center gap-1 rounded-full bg-[#FDECEC] px-2.5 py-1 font-black uppercase text-[#B42318] dark:bg-[#3A1E1E] dark:text-[#FCA5A5]">
                  ...
                  <div className="shrink-0 text-right">
                    <p className="text-2xl font-black text-[#B42318] dark:text-[#FCA5A5]">
                      ₹{order.total}
                    </p>
              ...
              <div className="p-3">
                <div className="rounded-xl border border-[#F3C6C2] bg-[#FDECEC] p-3 dark:border-[#5B2A2A] dark:bg-[#2A1A1A]">
                  <p className="text-[10px] font-black uppercase tracking-[0.14em] text-[#B42318] dark:text-[#FCA5A5]">
                    Cancellation Reason
                  </p>

                  <p className="mt-1 text-sm leading-6 text-[#7A271A] dark:text-[#FECACA]">
